<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StepTemplate.aspx.cs" Inherits="ITWorkShopHomePage.StepTemplate" %>
     ...
     <div class="smartflow_content">
         ...
         <div>
            ...
            <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
                <legend><asp:Label ID="legendTitle" runat="server"></asp:Label></legend>
            </fieldset>
            <asp:GridView ID="GridView1" CssClass="GridView_colume" AllowPaging="True" AllowSorting="True" runat="server" CellPadding="0" ForeColor="#333333" GridLines="Vertical" OnPageIndexChanging="GridView1_PageIndexChanging" OnSorting="GridView1_Sorting" DataKeyNames="id" EmptyDataText="NULL" AutoGenerateColumns="False" Width="98%" HorizontalAlign="Center" OnRowUpdating="GridView1_RowUpdating" PageSize="20" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" >
...
<ItemStyle Wrap="True"></ItemStyle>
                        ...
                        <asp:TemplateField HeaderText="流程进度">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddl2" DataSource="<%# ddl2_data()%>" DataValueField="Step" runat="server" AutoPostBack="False">
                                </asp:DropDownList>
                            </ItemTemplate>
                        </asp:TemplateField>
